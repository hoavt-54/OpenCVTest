...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, boolean showCamera, int column){
        ...
        picasso = new Picasso.Builder(mContext).listener(new Picasso.Listener() {
            @Override
...
*/
    ...
    class ViewHolder {
        ...
        void bindData(final Image data){
            //Log.e("bindData", "data: " + (data == null ? "null" : data.path));
            if(data == null) return;
            // 处理单选和多选状态
            ...
            if (imageFile.exists()) {
                // 显示图片
                //Log.e("bindData", "image file exists");
                ...
                //Log.e("bindData", "image file does not exist");
